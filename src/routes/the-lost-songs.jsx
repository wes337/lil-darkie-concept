      ...
      <div className="the-lost-songs">
        <div className="the-lost-songs-header">
          ...
          <div className="the-lost-songs-album-text">
            ...
            <Link
              to="https://open.spotify.com/album/0dbZCuF9B22PA9d0ZJnhaT?si=zh6EmpCOQiqTevdqogEagA&nd=1"
              target="_blank"
            >
              Listen on Spotify
            </Link>
        ...
        <div className="the-lost-songs-map">
          ...
          <p>
            <em>
              ...
              with me, and if you'd like to hear my creator's thoughts on these
              sounds just continue reading!”
            </em>
            <br />
            <span>- Dark One</span>
          </p>
        ...
        <div className="the-lost-songs-songs">
          ...
          <div className="the-lost-songs-song">
            ...
            <p>
              ...
              The Small Dark One and it wasn't included because it felt fun and
              informal in a way that I didn't think complimented the rest of the
              project. However, it is one of my favorites. Mainly because it is
              based. That is all.
            </p>
          </div>
          <div className="the-lost-songs-song">
            ...
            <p>
              ...
              people don't feel comfortable showing their teeth. Or standing up
              straight and just rapping. Even if some people think it's
              old-school and corny I grew up listening to music like that and
              making it brings me back to times I would freestyle with Wendigo
              while hanging out in New York or Cxrpse, Cube, and Bruhmane at a
              park in Long Beach. A lot of times the freestyles would be goofy
              and fun but sometimes they would be about something happening in
              the moment. Sometimes something intense or negative. This song
              just seeks to capture a moment of inspiration.
            </p>
          </div>
          <div className="the-lost-songs-song">
            ...
            <p>
              ...
              band but I still think it's a pleasant demo to listen to. I like
              walking to it because the tempo is good for it. It's just
              dissonant enough for me to feel nice and on edge. And Wendigo's
              guitar tickles my ear. That is all. Murder song but I am not the
              murderer.
            </p>
          </div>
          <div className="the-lost-songs-song">
          ...
          <div className="the-lost-songs-song">
            ...
            <p>
              I recorded this around the Swamp era! Honestly just didn't drop it
              because I felt the timing for this as a single just wasn't right
              considering I had just dropped what I considered my craziest
              project at that time. Just me having fun. I wanna do a video in a
              fancy restaurant.
            </p>
          </div>
          <div className="the-lost-songs-song">
          ...
          <div className="the-lost-songs-song">
            ...
            <p>
              I almost wasn't going to put songs 14, 15, and 16 on the project
              but Wendigo inspired me otherwise. I was looking through my old
              music with him on the phone and this song played. He said it
              should go on there because the fans who love our old music would
              love it. I initially resisted because I ended up not putting this
              song on Swamp because it felt too on the nose as a “song Darkie
              would make”. But I realized he was right. Some of my fans would
              find this song a fun return to something I have moved away from
              somewhat and that is CRAZY MIDDLE EASTERN THEMED SONGS. Honestly
        ...
        <div className="the-lost-songs-map">
          <p>
            <em>
              ...
              I GOT GOLD TO FIND IN THESE HILLS AND IT WON'T PAN ITSELF! Come
              again any time though! BYE!”
            </em>
            <br />
            <span>- Dark One</span>
          </p>
